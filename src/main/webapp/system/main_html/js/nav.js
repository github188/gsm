var sNodes=[
	{ "id":"1", "parentId":"0", "name":"员工管理","url":"empManage", "isParent": "true","icon": "./skin/index_icon.png","backgroundPosition":"-111px -48px"},

    { "id":"2", "parentId":"0", "name":"库存管理","url":"stockManage", "isParent": "true","icon": "./skin/room_icon.png","backgroundPosition":"-111px -48px"},
    { "id":"201", "parentId":"2", "name":"库存管理","icon": "./skin/index_icon.png","backgroundPosition":"-111px -48px"},
    { "id":"2101", "parentId":"201", "name":"库房管理","url":"stockManage", "target":"frmright","title":"textinput/password","icon": "./skin/index_icon.png","backgroundPosition":"-160px -48px"},
	{ "id":"2102", "parentId":"201", "name":"出入库记录","url":"stockManage/stockRecords", "target":"frmright","title":"textinput/password","icon": "./skin/index_icon.png","backgroundPosition":"-160px -48px"},
